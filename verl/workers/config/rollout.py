...
class AgentLoopConfig(BaseConfig):
    num_workers: int = 8
    # Maximum concurrent trajectories launched inside each AgentLoopWorker.
    # None/0 preserves the original behavior of launching the whole worker chunk.
...
class RolloutConfig(BaseConfig):
    ...
    extract_latent_action: bool = False
